...
import com.epiboly.bea2.http.api.EditPasswordApi;
import com.epiboly.bea2.http.api.EditTradePasswordApi;
...
public final class TradePasswordResetActivity extends AppActivity
        implements TextView.OnEditorActionListener {

    @Log
    public static void start(Context context, String phone) {
        Intent intent = new Intent(context, TradePasswordResetActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.trade_password_reset_activity;
    }
    ...
    public void onClick(View view) {
        if (view == mCommitView) {
            if (TextUtils.isEmpty(mFirstPassword.getText().toString()) || TextUtils.isEmpty(mSecondPassword.getText().toString())){
