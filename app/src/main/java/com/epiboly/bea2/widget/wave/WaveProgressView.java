package com.epiboly.bea2.widget.wave;
...
import com.epiboly.bea2.util.DimenKt;
...
public class WaveProgressView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        waveWidth = typedArray.getDimension(R.styleable.WaveProgressView_wave_width,DimenKt.getDp(25));
        waveHeight = typedArray.getDimension(R.styleable.WaveProgressView_wave_height,DimenKt.getDp(5));
        ...
        defaultSize = (int) DimenKt.getDp(100);
