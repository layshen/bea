 ...
 * @describe 开屏广告
 */
class SplashAdActivity : AppActivity() {
    ...
    companion object {
        fun action(context: Context) {
            context.startActivity(Intent(context, SplashAdActivity::class.java))
        }
    }

    override fun getLayoutId() = R.layout.activity_ad_splash
